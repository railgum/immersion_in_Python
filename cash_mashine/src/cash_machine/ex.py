...
def make_window(theme=None):
    ...
    layout_l = [
        ...
        [name('Combo'),
         sg.Combo(sg.theme_list(), default_value=sg.theme(), s=(15, 22), enable_events=True,
    ...
    layout_r = [
        ...
        [name('Tab, TabGroup'),
         sg.TabGroup([[sg.Tab('Tab1', [[sg.T(s=(15, 2))]]), sg.Tab('Tab2', [[]])]])],
    ...
    layout = [[Menu([['File', ['Exit']], ['Edit', ['Edit Me', ]]], k='-CUST MENUBAR-', p=0)],
              [sg.T('PySimpleGUI Elements - Use Combo to Change Themes', font='_ 14',
